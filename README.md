...
pull requests to the Talos project.

Collaborators should feel free to take full responsibility for
managing issues and pull requests they feel qualified to handle, as
long as this is done while being mindful of these guidelines, the
opinions of other Collaborators and guidance of the TC (Technical Committee).

Collaborators may **close** any issue or pull request they believe is
not relevant for the future of the Talos project. Where this is
unclear, the issue should be left open for several days to allow for
additional discussion. Where this does not yield input from Talos
...
All modifications to the Talos code and documentation should be
...
continuous integration tests on the selected CI server.

### Involving the TC (Technical Committee)
...
```text
$ curl -L https://github.com/talosdigital/TDUser/pull/xxx.patch | git am --whitespace=fix
```
...
messages. However, you are only allowed to force push to any Talos
...
- What's the process to see my contribution in the repository?
- Who accepts my code?
