# Talos Project Governance

## Technical Committee

The Talos projects are jointly governed by a Technical Steering Committee (TSC)
...
had been active contributors to Talos, and who have significant
experience with the management of a Talos project. Membership is
expected to evolve over time according to the needs of the project.

For the current list of TSC members, see the project README.md file.

## Collaborators

The [talosdigital](https://github.com/talosdigital) GitHub repository is
maintained by the TC (Technical Committee) and additional Collaborators who are added by the TC on an ongoing basis.
...
Modifications of the contents of the Talos repositories are made on
...
For the current list of Collaborators, see the project README.md file.
...
TC (Technical Committee) seats are not time-limited.  There is no fixed size of the TC.
However, the expected target is between 3 and 9, to ensure adequate
...
The TC meets weekly on a Google Hangout On Air or Skype. The meeting is run by
a designated moderator approved by the TC. 
